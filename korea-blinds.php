                            ...
                            <div class="col-lg-6 col-12">
                                <div class="feature-content">
                                    <div class="test-primary">
                                        <h1 class="pb-2 mt-0">Meet Our: <span> korea Blinds</span></h1>
                                    </div>
                                    <p>If you are unfamiliar, Korean blinds are also commonly known as rainbow blinds or combi blinds. While a traditional blind comes in one layer, a Korean blind comes in 2 layers of fabric. Typically, the 2 layers are made of polyester and one perforated material.</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-12">
        ...
        <div class="container">
            <div class="row justify-content-center g-lg-5 g-3">
                <div class="col-12 text-center">
                    <div class="test-primary">
                        <h1 class="mt-lg-0">Korea Blinds: <span> Specialized Features</span></h1>
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="features">
                        ...
                        <h5>Diverse Designs to Reflect Your Style</h5>
                        <ul>
                            <li>
                                <p>Explore an array of impressively creative designs, colors, and fabrics.</p>
                            </li>
                            <li>
                                <p>Customize your blinds with a personal touch, including specific prints to match your unique taste.</p>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="features">
                        ...
                        <ul>
                            <li>
                                <p>Elevate your living spaces with Korean blinds that stand at the top of the range.</p>
                            </li>
                            <li>
                                <p>Despite a slightly higher cost, experience the class, elegance, and premium aesthetic that transforms your home.</p>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="features">
                        ...
                        <h5>Transformative Ambiance for Your Home</h5>
                        <ul>
                            <li>
                                <p>Experience the incredible ability of Korean blinds to turn dull spaces into posh and cozy retreats.</p>
                            </li>
                            <li>
                                <p>Anticipate coming home to an elegant atmosphere and entertain guests proudly in a space that reflects your great taste in design.</p>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="features">
                        ...
                        <ul>
                            <li>
                                <p>Immerse yourself in the comfort of a home adorned with Korean blinds, where style meets functionality.</p>
                            </li>
                            <li>
                                <p>Enjoy not only the aesthetic appeal but also the cozy ambiance created by these blinds, making your living spaces a welcoming haven.</p>
                            </li>
                        </ul>
                    </div>
                </div>
